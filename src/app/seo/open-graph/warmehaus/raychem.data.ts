...
export class MetaRaychem implements IMetaData {
  ...
  // tslint:disable-next-line:max-line-length
  descriptionContent = 'Греющий кабель Raychem T2Blue представляет собой изготовленную в заводских условиях нагревательную секцию. Такой греющий кабель Raychem T2Blue подходит как для комфортного, так и для полного обогрева помещений со сложной конфигурацией.';
  ogTitle = 'og:title';
  ogTitleContent = 'Теплые полы Raychem дешево';
  ogDescription = 'og:description';
  // tslint:disable-next-line:max-line-length
  ogDescriptionContent = 'Греющий кабель Raychem T2Blue представляет собой изготовленную в заводских условиях нагревательную секцию. Такой греющий кабель Raychem T2Blue подходит как для комфортного, так и для полного обогрева помещений со сложной конфигурацией.';
  ogType = 'og:type';
