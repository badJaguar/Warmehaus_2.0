...
export class MetaMat200 implements IMetaData {
  keywords = 'keywords';
  // tslint:disable-next-line: max-line-length
  keywordsContent = 'теплый пол под плитку, теплый пол в слой плиточного клея, кабель в плиточный клей, мат под плитку, warmehaus мат 200 ватт, нагревательный мат, электро теплые полы под плитку';
  ...
  ogTitle = 'og:title';
  ogTitleContent = 'Системы теплого пола "Мат 200 Ватт"';
  ...
  ogUrl = 'og:url';
  ogUrlContent = 'https://warmehaus.com.by/mat-200Watt';
}
